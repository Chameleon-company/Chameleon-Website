...
const SearchBox = () => {
  ...
  return (
    <div className="relative w-full flex flex-nowrap items-stretch">
      <input
        type="search"
      ...
      <button
        ...
        bg-primary px-6 py-2.5 text-xs font-medium uppercase 
        leading-tight text-white shadow-md transition duration-150 ease-in-out 
        hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg 
