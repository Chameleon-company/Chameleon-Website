...
function Header() {
  // Add Modal Show State
  const [modalShow, setModalShow] = React.useState(false);
  return (
    // Add expand="lg" for making navbvar responsive & Change Class From navbar to navbar-dark to make menu hamburger icon color white. 
    <Navbar expand="lg" className="navbar-dark bg-dark">
      <Container>
        ...
        {/* Changed Class basic-navbar-nav to responsive-navbar-nav to make it responsive */}
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto">
            ...
            {/* Added Class outer-form cause this is outer form which will hide on Tablet */}
