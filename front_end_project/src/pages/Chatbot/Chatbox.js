...
import PropTypes from 'prop-types'; // newly added 
import chameleonLogo from '../../assets/ChameleonLogo.png'; // Adjust the path if necessary
import chatOpenImg from './images/chat-open.png';
import chatCloseImg from './images/chat-close.png';
import dotMenuImg from './images/dot-menu.png';
import chatIcon from './images/chat-icon.png';
import fileSelectIcon from './images/file-select.png';
