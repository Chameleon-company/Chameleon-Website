...
import "./ProjectPage-media.css";
import Slider from "../../components/PortfolioCard/Slider";
import ProjectCard from "../../components/PortfolioCard/ProjectCard";
import { SliderData, ProjectCardData } from "./project";
...
const Projects_id = () => {
  return (
    <div id="projects" Style="w-full h-[100vh-80ppx]">
