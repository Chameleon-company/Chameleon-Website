            ...
            <div className="login-centered-container">
              ...
              {showToast && (
                ...
                <div className="auth-form">
                  {!this.state.isSignUp && <h2>Welcome Back</h2>}
                  {this.state.isSignUp && <h2>Sign Up Now</h2>}
                  <form onSubmit={this.handleSubmitSignIn}>
                    ...
                    {!this.state.isSignUp && <p class="forgot-pass">
                      <a href="/reset">Forgot your password?</a>
                    </p>}

                    {!this.state.isSignUp && <button
                      type="button submit"
