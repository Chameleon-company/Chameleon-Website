...
import { notifySuccess, notifyError } from '../../components/notificationComp/NotificationComponent';
...
class Login extends Component {
  handleLogin = (e) => {
    ...
    if (email === 'user@example.com' && password === 'password') {
      // For example, show success notification
      notifySuccess("Login successful!");
    } else {
      // For example, show error notification
