...
class Login extends Component {
    ...
    handleExternalSignIn = (service) => {
        ...
        signInWithPopup(auth, provider)
            .then((result) => {
                this.displayToast(`Sign in with ${service} successful!`);
            ...
            .catch((error) => {
                console.error(`Error during ${service} sign-in:`, error);
                this.displayToast(`Sign in with ${service} failed. Please try again.`);
            });
    };
                ...
                {/* <Screen>
                            ...
                            <div className={`dowebok ${isSignUp ? 's--signup' : ''}`}>
                                ...
                                <div className="form sign-in">
                                    ...
                                    <form onSubmit={this.handleSubmitSignIn}>
                                        ...
                                        <button type="submit" className="submit signin-up-button">Log In</button>
                                        <div className='bottom-box'>
                                            <svg type="button" onClick={() => this.handleExternalSignIn('Facebook')} className="icon" viewBox="0 0 1026 1024" width="40" height="40">
                                                <path d="M512.034307 0C229.72222 0 0.002375 229.655981 0.002375 512S229.72222 1024 512.034307 1024 1024.066239 794.344019 1024.066239 512 794.346394 0 512.034307 0z m0 989.89647C248.530253 989.89647 34.169769 775.504054 34.169769 512S248.530253 34.10353 512.034307 34.10353 989.898845 248.495946 989.898845 512 775.538361 989.89647 512.034307 989.89647z" fill="#828282" />
                                                <path d="M623.796812 224.610702h-85.194961C430.096425 223.525009 416.237875 290.678309 416.237875 363.355869V416.203567h-47.898217a14.209804 14.209804 0 0 0-15.966072 15.966073v95.796432a14.209804 14.209804 0 0 0 15.966072 15.966072H416.237875v239.491082a14.337533 14.337533 0 0 0 16.061868 15.966072h97.552701c9.419983 1.085693 17.051765-6.54609 14.050143-15.966072L543.966451 543.932144h79.830361a14.209804 14.209804 0 0 0 15.966072-15.966072v-95.796432a14.209804 14.209804 0 0 0-15.966072-15.966073h-79.926157L543.966451 368.305351c3.097418-20.40464 3.097418-17.083697 22.03318-15.966072h57.126606c4.438568-0.989896 9.164525-0.44705 12.485468-3.672197 3.320943-3.225147 5.236872-7.631782 4.119247-12.293875v-95.796433A14.177872 14.177872 0 0 0 623.796812 224.610702z m-17.083697 94.008233l-40.042909-1.532743c-49.59062 0-53.741799 26.918798-53.741799 54.476238l-0.127728 60.543345a17.051765 17.051765 0 0 0 17.051765 17.083697H607.83074v61.692903h-77.914432a17.083697 17.083697 0 0 0-17.083697 17.051765L512.800679 767.457154H448.170019v-239.491082c0-9.419983-6.418361-17.051765-15.870276-17.051765H384.30573v-61.692902h47.994013a17.051765 17.051765 0 0 0 12.070351-4.981415c3.193214-3.225147 3.767993-7.567918 3.767993-12.102283v-68.81377c0-71.591867 14.465261-105.695397 90.431832-105.695398h68.111263v60.990396z" fill="#828282" />
                                            </svg>
                                            <div className='width5'></div>
                                            <svg type="button" onClick={() => this.handleExternalSignIn('Google')} className="icon" viewBox="0 0 1024 1024" width="40" height="40">
                                                <path d="M512 1017q-103 0-197-40-90-38-160-108T47 709Q7 615 7 512t40-197q38-90 108-160T315 47Q409 7 512 7t197 40q90 38 160 108t108 160q40 94 40 196.5T977 709q-38 90-108 160T709 977q-94 40-197 40z m0-999q-100 0-192 39-89 37-157.5 105.5T57 320q-39 92-39 192t39 192q37 89 105.5 157.5T320 967q92 39 192 39t192-39q89-37 157.5-105.5T967 704q39-92 39-192t-39-192q-37-89-105.5-157.5T704 57q-92-39-192-39z m0 1006q-104 0-199-40-92-39-163-110T40 711Q0 616 0 512t40-199q39-92 110-163T313 40Q408 0 512 0t199 40q92 39 163 110t110 163q40 95 40 199t-40 199q-39 92-110 163T711 984q-95 40-199 40z m0-1000q-99 0-190 39-87 37-154.5 104.5T63 322q-38 91-38.5 190T63 702q37 87 104.5 154.5T322 961q91 38 190 38t189-38q88-37 155.5-104.5T961 702q38-91 38-190t-38-190q-37-87-104.5-154.5T702 63q-91-39-190-39z m297 432H519v119h166q-6 29-21.5 53T623 668q-44 29-103.5 29t-107-35.5Q365 626 347 571q-10-30-10-59.5t10-58.5q18-55 65.5-90.5T519 327q70 0 118 46l88-89q-41-38-92-59-53-21-114-21-89 0-163 47-73 46-112 123-32 65-32 138t32 138q39 77 112 123 74 47 163 47 62 0 113.5-19.5T723 745q44-40 68-98t24-128q0-32-6-63z" fill="#666666" />
                                            </svg>
                                            <div className='width5'></div>
                                            <svg type="button" onClick={() => this.handleExternalSignIn('GitHub')} className="icon" viewBox="0 0 1024 1024" width="40" height="40">
                                                <path d="M512 0C229.226667 0 0 229.226667 0 512c0 226.986667 146.56 419.306667 349.013333 487.253333 25.6 4.693333 35.626667-10.986667 35.626667-25.6V863.36C253.44 879.786667 220.16 818.346667 207.36 782.506667 202.666667 769.706667 176.64 727.466667 151.04 713.386667 129.706667 702.293333 109.013333 677.546667 151.04 677.546667 188.586667 677.546667 220.16 714.666667 231.893333 731.306667c31.573333 52.053333 74.026667 74.026667 117.546667 74.026666 39.466667 0 66.133333-14.08 83.626666-29.866666 11.52-35.626667 28.586667-65.706667 52.693334-89.813334-124.586667-16.426667-253.866667-62.506667-253.866667-278.613333 0-61.44 22.506667-111.36 59.733333-150.613333-5.12-17.066667-24.32-85.333333 5.12-177.066667 0 0 46.08-14.08 151.04 59.733333 43.52-12.586667 89.813333-19.306667 136.106667-19.306666 46.08 0 92.373333 6.72 136.106666 19.306666 104.96-74.026667 151.04-59.733333 151.04-59.733333 29.866667 91.733333 10.24 160-4.693333 177.066667 37.226667 39.253333 60.586667 89.813333 60.586667 150.613333 0 216.106667-130.133333 262.186667-254.72 278.613333 29.866667 28.586667 54.4 81.706667 54.4 165.12v130.133334c0 14.613333 10.24 30.293333 35.626667 25.6C877.44 931.306667 1024 739.84 1024 512 1024 229.226667 794.773333 0 512 0z" fill="#000000" />
                                            </svg>
                                        </div>
                                    </form>
                                    <p className="signup">Don't have an account? <a href="signup" onClick={this.toggleSignUp}>Sign up</a></p>
                    ...
                    <div className="auth-form-switch">
                        ...
                        <div className="img__btn" onClick={this.toggleSignUp}>
                            {!this.state.isSignUp ? <span className="m--up">Sign Up</span> :
