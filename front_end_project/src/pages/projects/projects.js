    ...
    <>
      ...
      <div className="bg-[#deece3]">
        ...
        <div className="flex flex-col items-center max-w-4xl mx-auto gap-3 py-6 px-3">
          ...
          <p className="text-black text-center lg:text-[18px] md:text-[17px] text-[16px] m-0 font-thin">
            {content1}
          </p>
        ...
        <div
          className={` ${styles.projectSection} bg-[#559066] text-black relative`}
        >
          ...
          <h3 className="text-center font-semibold lg:text-4xl sm:text-3xl text-[26px] uppercase text-white">
            Our Projects
          </h3>
          ...
          <div className="flex flex-col items-center justify-center lg:flex-row text-center lg:justify-around gap-4 p-5 container">
            {projectList.map((item) => (
              <a href={`/project/${item.id}`} className="no-underline">
                ...
                {/* <div className="bg-[#D1E1C4] lg:p-8 md:p-6 p-[15px] lg:pb-4 pb-3 text-center "> */}
                {/* this */}
                <div className="max-w-sm bg-green-sage border border-gray-200 rounded-lg shadow">
                  <img
                    alt=""
                    src={item.image}
                    className="w-100 h-[235px] fill "
                  />
          ...
          <div
            id="chatbot"
            className="chatBot absolute right-4 bottom-5 flex flex-col"
          >
            {!chatOpen && (
              <img
                alt=""
