          ...
          <div className={`dowebok ${isSignUp ? "s--signup" : ""}`}>
            <div class="form sign-in">
              ...
              <form onSubmit={this.handleSubmitSignIn}>
                ...
                <button type="button" class="submit signin-up-button">
                  Log In
                </button>
              ...
              {/* <button type="button" class="fb-btn signin-up-button" src={google} onClick={() => this.handleExternalSignIn('Google')}>Log In with <span>Google</span> Account</button> */}
            </div>
            <div class="sub-cont">
              <div class="img">
              ...
              <div class="form sign-up">
                ...
                {/* <button type="button" class="fb-btn signin-up-button" src={google} onClick={() => this.handleExternalSignUp('Google')}>Log In with <span>Google</span> Account</button> */}
              </div>
            </div>
          </div>
        </div>
